const dressOptions = [
    {
        id: 1,
        name: "James Dusty Sage Structured Stretch Suit ",
        image: "https://cdn-1.azazie.com/upimg/h65/29/cc/a9eda66f605bf4dd406252a0b73e29cc.jpg.webp",
        purchaseUrl: "https://www.azazie.com/products/james-dusty-sage-suit/77428597",
    },
];
        ...
        <div className="outfit-assignment">
            <section className="outfit-section">
                ...
                <div className="card-btn-container">
                    <a
                        href="https://www.azazie.com/products/james-dusty-sage-suit/77428597"
                        target="_blank"
                        rel="noreferrer"
                        className="card-btn"
                    >
