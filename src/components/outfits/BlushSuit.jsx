const dressOptions = [
    {
        id: 1,
        name: "James Dusty Rose Structured Stretch Suit ",
        image: "https://cdn-1.azazie.com/upimg/h65/48/4e/d2f9395b8819ee18b7aee48e674b484e.jpg.webp",
        purchaseUrl: "https://www.azazie.com/products/james-dusty-rose-suit/77428596",
    },
];
...
const tieOptions = [
    {
        id: 1,
        name: "Black Simon Tie",
        image: "https://cdn.shopify.com/s/files/1/2053/3799/files/black_simon_tie_1.jpg.webp?v=1741983415&width=768&height=1152&crop=center&quality=85",
        purchaseUrl: "https://www.birdygrey.com/products/simon-necktie-black"
    },
]
        ...
        <div className="outfit-assignment">
            <section className="outfit-section">
                ...
                <div className="card-btn-container">
                    <a
                        href="https://www.azazie.com/products/james-dusty-rose-suit/77428596"
                        target="_blank"
                        rel="noreferrer"
                        className="card-btn"
                    >
            ...
            <section className="outfit-section">
                <div className="outfit-section__heading">
                    <div>
                        <h2>Shoes</h2>
                        You are welcome to wear any black dress shoe you would like, including, but not limited to the following.
                    </div>
                </div>
            ...
            <section className="outfit-section">
                ...
                <div className="card-btn-container">
                    <a
                        href="https://www.birdygrey.com/products/simon-necktie-black"
                        target="_blank"
                        rel="noreferrer"
                        className="card-btn"
                    >
